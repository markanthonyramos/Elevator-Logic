...
public class Foo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jSpinner6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 360, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        int selectedAmount5 = Integer.parseInt(jSpinner6.getValue().toString());
        ...
        switch (option2.getSelectedItem().toString()) {
            case "None":
                SB.append("");
                totalPrice += 0;
                break;
        ...
        switch (option3.getSelectedItem().toString()) {
            case "None":
                SB.append("");
                totalPrice += 0;
                break;
        ...
        switch (option4.getSelectedItem().toString()) {
            case "None":
                SB.append("");
                totalPrice += 0;
                break;
        ...
        switch (option5.getSelectedItem().toString()) {
            case "None":
                SB.append("");
                totalPrice += 0;
                break;
            case "Milk":
                ...
                break;
            case "Eggs":
                option5TotalValue = 10 * selectedAmount4;
                SB.append("\n"+selectedValue4+" | " + option5TotalValue);
                totalPrice += option5TotalValue;
                break;
            case "Cheese":
        ...
        switch (option6.getSelectedItem().toString()) {
            case "None":
                SB.append("");
                totalPrice += 0;
                break;
        ...
        int ans = totalPrice + 20;
        SB.append("\n ").append("\n");
        SB.append("\nDelivery fee | 20").append("\n");
        SB.append("\n-------------------------------------").append("\n");
